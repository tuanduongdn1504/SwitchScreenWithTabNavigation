    ...
    return (
      <View style={[styles.container, this.props.style]}>
        <TouchableWithoutFeedback
          style={[styles.avatar, { borderRadius: this.props.circle ? 75 : 0 }]}
          underlayColor="white"
        ...
        >
          <View style={[styles.avatarContainer]}>
            <Image
              ...
              style={[styles.avatar, { borderRadius: this.props.circle ? 50 : 0 }]}
              defaultSource={Images.defaultUser}
              source={this.state.avatarSource ? this.state.avatarSource : Images.primary}
            />
            {
