...
class Safety extends Component {
  ...
  renderShareSheet = () => {
    ...
    const mapUrl = `http://maps.google.com/maps?q=loc:${latitude},${longitude}`;
    const message = `Now I'm in this place. Please come help me.
    ${mapUrl}`;
    ...
    const shareOptions = {
      ...
      message,
      url: mapUrl,
      subject: 'Help me', //  for email
    };
    return (
      <ShareSheet visible={visible} onCancel={this.onCancel}>
        <Button
            ...
            setTimeout(() => {
              if (typeof shareOptions.url !== 'undefined') {
                ...
                if (Platform.OS === 'android') {
                  ToastAndroid.show(I18n.t('safety.copiedToClipboard'), ToastAndroid.SHORT);
                } else if (Platform.OS === 'ios') {
                  AlertIOS.alert(I18n.t('safety.copiedToClipboard'));
                }
              }
            }, 300);
          }}
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.vInfo}>
          ...
          <CustomButton style={styles.button} onPress={this.onOpen} buttonTitle={I18n.t('share')} />
        </View>
